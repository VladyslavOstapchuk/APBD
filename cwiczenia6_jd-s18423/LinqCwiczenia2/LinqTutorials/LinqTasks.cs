...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            ...
            //    if (e.Job == "Backend programmer") {
            //        res.Add(e);
            //    }                
            //}

            //Lambda exprassion syntax, Fluent
        ...
        {
            IEnumerable<Emp> result = from e in Emps 
                                      where e.Salary == (from e1 in Emps select e1.Salary).Max()
                                      select e;
            foreach (var r in result)
                Console.WriteLine(r);
            Console.WriteLine();
        ...
        public static IEnumerable<object> Task6()
        {
            IEnumerable<object> result = from e in Emps
                                         ...
                                         select e.Ename + ", " + e.Job + " działu " + dept.Dname;
            foreach (var r in result)
                Console.WriteLine(r);
            Console.WriteLine();
        ...
        {
            bool result = (from e in Emps
                           where e.Job == "Backend programmer"
                           select e).Any();

            Console.WriteLine( result ? "w kolekcji jest Backend programmer" : "w kolekcji nie ma Backend programmera");
